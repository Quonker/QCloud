...
namespace WebImageCloud.Controllers
{
    public class FilesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Path,Size,FolderId")] File file)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int? id, [Bind("Id,Name,Path,Size,FolderId")] File file)
        {
            if (id != file.Id)
            {
                return NotFound();
